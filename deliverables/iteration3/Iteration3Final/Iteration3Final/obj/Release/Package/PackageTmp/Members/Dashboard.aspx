...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="jumbotron">
       ...
       <div class="jumbodiv">
       <div id="myTabs" style="width:100%; background-color: #ddddff">
            <ul>
                <li><a href="#tab-1" style="background-color: #ddddff;">Deposits/Expenses</a></li>
                <li><a href="#tab-2" style="background-color: #ddddff;">Manage Expense Categories</a></li>
                <li><a href="#tab-3" style="background-color: #ddddff;">Add Bills, Loans, Savings</a></li>
            </ul>
            <div id="tab-1" style="background-color: #ddddff;">
                <div class="jumbotab">
            ...
            <div id="tab-2" style="background-color: #ddddff;">
                <div class="jumbotab">
            ...
            <div id="tab-3" style="background-color: #ddddff;">
                <div class="jumbotab">
